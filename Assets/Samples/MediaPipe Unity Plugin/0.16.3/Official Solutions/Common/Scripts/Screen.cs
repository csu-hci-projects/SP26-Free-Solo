...
namespace Mediapipe.Unity
{
    public class Screen : MonoBehaviour
    {
        ...
        public void Initialize(ImageSource imageSource)
        {
            ...
            // Use fallback resolution if webcam isn't ready yet (e.g. slow external webcam)
            var width = _imageSource.textureWidth > 0 ? _imageSource.textureWidth : 1280;
            var height = _imageSource.textureHeight > 0 ? _imageSource.textureHeight : 720;
